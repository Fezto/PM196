  ...
  useEffect(() => {
    const obtenerDatos = async () => {
      try {
        ...
        const todosLosPokemon = seccionesFinales.flatMap(
  ...
  const renderItemPokemon = ({ item }) => (
    <View style={styles.item}>
      <Image
        ...
        defaultSource={{
          uri: "https://placehold.co/60x60/cccccc/ffffff?text=...",
        }}
      />
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.switchContainer}>
        <TouchableOpacity
          style={[
            styles.switchButton,
            tipoDeLista === "section" && styles.switchButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              ...
              tipoDeLista === "section" && styles.switchButtonTextActive,
            ]}
          >
        ...
        <TouchableOpacity
          style={[
            styles.switchButton,
            tipoDeLista === "flat" && styles.switchButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              styles.switchButtonText,
              tipoDeLista === "flat" && styles.switchButtonTextActive,
            ]}
          >
      ...
      {tipoDeLista === "section" ? (
        ...
        <SectionList
          ...
          ListHeaderComponent={
            <Text style={styles.mainTitle}>Pokédex con SectionList</Text>
          }
        />
      ) : (
        // EJEMPLO DE FLATLIST
        <FlatList
          ...
          renderItem={renderItemPokemon}
          ListHeaderComponent={
            <Text style={styles.mainTitle}>Pokédex con FlatList</Text>
          }
        />
      )}
    </SafeAreaView>
